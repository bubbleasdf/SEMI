...
public class Notice implements Serializable{
	...
	public Notice(int nno, String nemail, String ntitle, String nContent, int nCount, Date ndate) {
		super();
		this.nno = nno;
		this.nemail = nemail;
		this.ntitle = ntitle;
	...
	public String toString() {
		return "Notice [nno=" + nno + ", nemail=" + nemail + ", ntitle=" + ntitle + ", nContent=" + nContent
