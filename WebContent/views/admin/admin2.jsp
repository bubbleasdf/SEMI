<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="com.kh.petner.market.model.vo.AdminMain, java.util.*"%>
								...
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div
											...
											호텔 개수</div>
										<div class="h5 mb-0 font-weight-bold text-gray-800"><%= am.getHotel() %></div>
									</div>
									<div class="col-auto">
										<i class="fas fa-calendar fa-2x text-gray-300"></i>
									</div>
								...
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div
											...
											미용 개수</div>
										<div class="h5 mb-0 font-weight-bold text-gray-800"><%= am.getBeauty() %></div>
									</div>
									<div class="col-auto">
										<i class="fas fa-calendar fa-2x text-gray-300"></i>
									</div>
								...
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div
											...
											병원 개수</div>
										<div class="h5 mb-0 font-weight-bold text-gray-800"><%= am.getHospital() %></div>
									</div>
									<div class="col-auto">
										<i class="fas fa-calendar fa-2x text-gray-300"></i>
									</div>
